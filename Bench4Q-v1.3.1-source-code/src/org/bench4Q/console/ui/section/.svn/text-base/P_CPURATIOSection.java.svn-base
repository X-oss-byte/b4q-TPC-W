...
public class P_CPURATIOSection extends JPanel implements ServerInfoObserver{
	 ...
	 */
	public P_CPURATIOSection(Resources resources,
			ProcessControl processControl,
			SwingDispatcherFactory dispatcherFactory,
			ServerCollection serverCollection) throws ConsoleException {
	 ...
	 * @return
	 */
	public JPanel printCPURatioPic() {
		...
		JFreeChart chart = ChartFactory.createLineChart("CPU Usage",
				"time (s)", "%", defaultcategorydataset,
		...
		// ds.addSeries("test (" + "Max = " + Max + " Min = " + Min +
		// " Average = " + Mean + " StDev = "+ Var + " )", result);
		// JFreeChart chart = ChartFactory.createXYLineChart("CPU Usage",
