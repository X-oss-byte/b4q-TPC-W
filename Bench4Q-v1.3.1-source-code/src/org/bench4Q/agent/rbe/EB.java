...
//			System.out.println("end");
	...
	public void setMix(String mixType){
		writeLock.lock();
		try {
			Mix mix = new Mix();
			Mix.initialize();
			if (mixType.equalsIgnoreCase("browsing")) {
				System.out.println("browsing");
				transProb = mix.getTransProb("browsing");
				trans = mix.getTrans("browsing");
			} else if (mixType.equalsIgnoreCase("shopping")) {
				System.out.println("shopping");
				transProb = mix.getTransProb("shopping");
				trans = mix.getTrans("shopping");
			} else if (mixType.equalsIgnoreCase("ordering")) {
	...
	public void setThinkTime(double tt){
		tt_scale = tt;
	}
